sr = read.table("../results/simulation50_results.txt", sep="\t", header=T)
...
ppall = subset(ppall, variable %in% c("PERMANOVA", "Tw2") & n1 %in% 48:52 & n2 %in% 48:52 & Effect %in% c(0, 2, 5) & Frac.S.D. %in% c(0.2, 0.8, 0.99))
...
# The following reproduced Figure 3(b)
pdf('../results/adonis_Tw_50.pdf', width=7, height=7)
